...
lift2 ::
  ...
  -> f b
  -> f c
lift2 g f_a f_b = pure g <*> f_a <*> f_b
...
lift3 ::
  ...
  -> f c
  -> f d
lift3 g f_a f_b f_c = pure g <*> f_a <*> f_b <*> f_c
...
lift4 ::
  ...
  -> f d
  -> f e
lift4 g f_a f_b f_c f_d = pure g <*> f_a <*> f_b <*> f_c <*> f_d
...
sequence (f_a :. l) = lift2 (:.) f_a $ sequence l
